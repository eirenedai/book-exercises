...
vehicle_models <- function(year_choice, make_choice){
  given_vehicle <- vehicles[(vehicles$make==make_choice)&(vehicles$year==year_choice),]
  max_vehicle <- given_vehicle[given_vehicle$hwy==max(given_vehicle$hwy),"hwy"]
  return(max_vehicle)
}
# What was the most efficient Honda model of 1995?
vehicle_models(1995,"Honda")
