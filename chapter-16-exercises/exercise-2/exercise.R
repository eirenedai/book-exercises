...
ggplot(data=diamonds_sample)+
  geom_col(
    mapping= aes(x=price, y=cut, fill=clarity), position="fill")

# Draw the same chart again, but with each element positioned to "dodge" each other
ggplot(data=diamonds_sample)+
  geom_col(
    mapping= aes(x=price, y=cut, fill=clarity), position="dodge")
...
ggplot(data=diamonds_sample)+
  geom_point(
    mapping= aes(x=cut, y=price, fill=clarity), position="jitter")
...
ggplot(diamonds_sample)+
  geom_bar(mapping=aes(x=cut, y=clarity), filled=cut)
