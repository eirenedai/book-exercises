...
my_movie <- review %>% 
  filter(display_title==movie_name) 
  
headline <- my_movie$headline  
short_summary <- my_movie$summary_short
link <- my_movie$link

# Create a list of the three pieces of information from above. 
# Print out the list.
info_list <- list(headline=headline, short_summary=short_summary, link=link)
print(info_list)
